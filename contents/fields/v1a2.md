...
2. Alle Beiträge der Studierenden und Mitdozierenden werden im philosophischen Diskurs zunächst toleriert und angehört.
    ...
    1. Das heißt unter anderem, dass Redebeiträge im philosophischen Diskurs **gleich** und **gerecht** verteilt werden.

         1. Kommt es zu Kritik, dann richtet sich diese ausschließlich an den Beitragsinhalt der Sprecherin; Kritik an der Person wird nicht geduldet.
